...
const Registration = () => {
    const { signInWithGoogle, createUser, updateUserProfile, user, setUser, EmailVerification } = useContext(AuthContext);
    ...
    const handleRegister = async (e) => {
        ...
        try {
            ...
            Swal.fire("Email verification sent to your inbox. Please verify your email.");
            ...
            const checkVerification = setInterval(async () => {
                ...
                if (result.user?.emailVerified) {
                    ...
                    await result.user.reload(); //reload user to get updated data from firebase
                    setUser({...result.user});
                    toast.success("Email verified successfully");
                    navigate("/");
                }
            }, 3000); //every 3 seconds check if email is verified
